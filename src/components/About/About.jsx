  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <p>Brandon Sanderson enjoys the method of creating a world, its cosmology, weather, flora, fauna, ect and then writing a story about people in that world.</p>
        <p>This style of writing can also be found in the greats of Gary Gygax and Dave Arneson who created a entire game system called D&D which encourages this style of design,</p>
