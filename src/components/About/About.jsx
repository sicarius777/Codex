  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <p>My name is Roderick D'Pen welcome to the Codex. I have been writing worlds for most of my life many of those worlds were lost with the passage of time and the infinite nature of many pieces of paper.</p>
